...
<body>
                            ...
                            <div class="col-lg-9">
                                <div class="collapse navbar-collapse" id="navbar-menu">
                                    <ul class="nav navbar-nav navbar-left" data-in="fadeInDown" data-out="fadeOutUp">
                                        ...
                                        <li>
                                            <a class="smooth-menu" href="#about">Sambutan Rektor</a>
                                        </li>
                                        <li>
                                            <a class="smooth-menu" href="#Tentang">Tentang</a>
                                        </li>
                                        <li>
                                            <a class="smooth-menu" href="#Petunjuk">Petunjuk Pengisian</a>
                                        </li>
                                        <li>
            ...
            <div class="about-items">
                ...
                <div class="row align-center">
                    <div class="col-lg-6 info">
                        ...
                        <blockquote>
                            DR. Umar Alatas, S.Pi.,M.Si.
                        </blockquote>
                        <p>
                            "Tracer study merupakan survei alumni dengan tujuan menggali informasi yang berkaitan dengan
                    ...
                    <div class="col-lg-6">
                        <div class="thumb">
                            <img src="{{ asset('assets/media/umar.png') }}" alt="Thumb">
                            <img src="{{ asset('assets/media/logos/logo-unisa.png') }}" alt="Thumb">
                            <div class="experience">
                                <h2>REKTOR</h2>
                                <h4>UNIVERSITAS ALKHAIRAAT PALU</h4>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 offset-lg-5 col-md-7 offset-md-5">
                    <div class="row">
                        <div class="col-lg-12 ml-2 choose-style-one">
                            <h5 class="sub-heading" style="color: #ffb400">Aplikasi Tracer Studi UNISA</h5>
    ...
    <!-- Start Process Area
    ============================================= -->
    <div id="Petunjuk" class="work-process-area shadow-less text-center default-padding">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        <h4>Petunjuk Pengisian</h4>
                        <h2>Berikut Merupakan Tahapan Pengisian Tracer Study UNISA</h2>
            ...
            <div class="process-items">
                <div class="row">
                    ...
                    <div class="single-item col-lg-3 col-md-6">
                        <div class="item">
                            <div class="thumb">
                                <img src="{{ asset('assets/icon/website.png') }}" alt="Thumb">
                                <span>01</span>
                            </div>
                            <h5>Akses Website Tracer Study</h5>
                            <p>Akses Halaman <a href="">Tracer Study UNISa</a></p>
                        </div>
                    </div>
                    <!-- End Single Item -->
                    <!-- Single Item -->
                    <div class="single-item col-lg-3 col-md-6">
                        <div class="item">
                            <div class="thumb">
                                <img src="{{ asset('assets/icon/login.png') }}" alt="Thumb">
                                <span>02</span>
                            </div>
                            <h5>Login Ke Sistem</h5>
                            <p>Login Menggunakan Username dan Password Nim Pada Saat Berkuliah di UNM</p>
                        </div>
                    </div>
                    <!-- End Single Item -->
                    <!-- Single Item -->
                    <div class="single-item col-lg-3 col-md-6">
                        <div class="item">
                            ...
                            <h5>Mengubah Data Profil</h5>
                            <p>Melakukan Update Terhadap Data Profile Sesuai dengan Status Alumni Sekarang</p>
                        </div>
                    </div>
                    <div class="single-item col-lg-3 col-md-6">
                        <div class="item">
                            ...
                            <h5>Pengisian Data Alumni</h5>
                            <p>Melakukan Pengisian Kuesioner Sesuai Dengan Status dan Kondisi Alumni Sekarang
                            </p>
                        </div>
                    </div>
                    <!-- End Single Item -->
