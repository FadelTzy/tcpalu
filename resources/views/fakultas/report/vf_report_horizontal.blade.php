            ...
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5">
                    <div class="card-title d-flex align-items-center">
                        ...
                        <h5 class="mb-0 text-primary">Report Keselarasan Horizontal (Kesesuaian Bidang Ilmu dengan Pekerjaan)
                        </h5>
                    </div>
                    <hr>
                    <form class="form-horizontal form-groups-bordered" name="formstatus" id="formstatus" method="post"
                        ...
                        <input type="hidden" name="jreport" id="jreport" value="horizontal">
                        <hr>
                        <div class="col-12">
