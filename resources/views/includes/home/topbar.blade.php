  ...
  <div class="container-fluid">
    <ul class="list-unstyled topnav-menu float-right mb-0">
          ...
          <div class="app-search-box dropdown">
            ...
            >
              ...
              <div class="dropdown-header noti-title">
                <h5 class="text-overflow mb-2 font-weight-medium">
              ...
              <div class="dropdown-header noti-title">
                <h6
                  class="text-overflow mb-2 text-uppercase font-weight-medium"
                >
                  Users
                </h6>
              </div>
      ...
      <li class="dropdown d-inline-block d-lg-none">
        ...
        <div
          class="dropdown-menu dropdown-lg dropdown-menu-right p-0"
        >
          <form class="p-3">
            <input
              type="text"
