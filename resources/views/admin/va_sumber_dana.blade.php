...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="page-content">
            <h6 class="mb-0 text-uppercase">Data Sumber Dana</h6>
            <hr />
            <div class="card">
            ...
            <div class="modal-content">
                <form name="formstatus" id="formstatus" method="post">
                    ...
                    <div class="modal-body mx-3">
                        <div class="form mb-3">
                            <label data-error="wrong" data-success="right" for="orangeForm-name">Nama Sumber Dana</label>
                            <input type="text" id="nama_sd" name="nama_sd" class="form-control validate">
                        </div>
                        <div class="form mb-3">
                            <label data-error="wrong" data-success="right" for="orangeForm-name">Nilai Sumber Dana</label>
                            <input type="text" id="nilai_sd" name="nilai_sd" class="form-control validate">
                        </div>
                    </div>
