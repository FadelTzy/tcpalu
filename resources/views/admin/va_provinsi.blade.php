...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="page-content">
            <h6 class="mb-0 text-uppercase">Data Provinsi</h6>
            <hr />
            <div class="card">
            ...
            <div class="modal-content">
                <form name="formstatus" id="formstatus" method="post">
                    ...
                    <div class="modal-body mx-3">
                        <div class="form mb-3">
                            <label data-error="wrong" data-success="right" for="orangeForm-name">ID Provinsi</label>
                            <input type="text" id="id_wil" name="id_wil" class="form-control validate">
                        </div>
                        <div class="form mb-3">
                            <label data-error="wrong" data-success="right" for="orangeForm-name">Nama Provinsi</label>
