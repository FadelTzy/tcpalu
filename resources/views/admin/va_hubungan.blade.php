...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="page-content">
            <h6 class="mb-0 text-uppercase">Data Parameter Hubungan</h6>
            <hr />
            <div class="card">
            ...
            <div class="modal-content">
                <form name="formstatus" id="formstatus" method="post">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Tambah Parameter Hubungan</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body mx-3">
                        <div class="form mb-3">
                            <label data-error="wrong" data-success="right" for="orangeForm-name">Nama Parameter</label>
                            <input type="text" id="nama_hub" name="nama_hub" class="form-control validate">
                        </div>
                        <div class="form mb-3">
                            <label data-error="wrong" data-success="right" for="orangeForm-name">Nilai Parameter</label>
                            <input type="text" id="nilai_hub" name="nilai_hub" class="form-control validate">
                        </div>
                    </div>
