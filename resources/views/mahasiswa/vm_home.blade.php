        ...
        <div class="page-content">
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3">
                ...
                <div class="col">
                    <div class="card radius-10">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <h5 class="mb-0 text-success">{{ $ntanggal }}</h5>
                                <div class="ms-auto">
                ...
                <div class="col">
                    <div class="card radius-10">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <h5 class="mb-0 text-danger">{{ $nkuesioner }}</h5>
                                <div class="ms-auto">
                            ...
                            {{-- <div class="progress my-2" style="height:4px;">
                                <div class="progress-bar bg-danger" role="progressbar" style="width: 20%"
                                    aria-valuenow="{{ $nkuesioner }}" aria-valuemin="0" aria-valuemax="1000"></div>
                            </div> --}}
                            <div class="d-flex align-items-center">
                                <p class="mb-0">Kuesioner Terkumpul</p>
                        ...
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <p>Dengan adanya aplikasi ini kami berharap agar alumni yang ada dapat kami tracking
                                    keberadaannya, sehingga ada timbal balik hubungan antara pihak universitas dan alumni
                                    yang ada. Keberadaan Alumni merupakan asset yang harus dipertahankan, mengingat
                                    almamater dengan alumni tidak bisa dipisahkan dalam hal berkomunikasi. Ada kebanggaan
                                    tersendiri jika kami bisa terus berkomunikasi dengan alumni yang ada. Terima kasih atas
                                    segala bentuk kerjasama yang telah dilakukan, besar harapan kami untuk segala testimoni,
            ...
            @if ($errors->any())
                <div class="alert alert-danger">
                    @foreach ($errors->all('Anda Telah Mengisi Kuesioner') as $error)
                        {{ $error }}
                    @endforeach
                </div>
            @endif
