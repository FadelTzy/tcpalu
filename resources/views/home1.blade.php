      ...
      <div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
        ...
        <div class="d-flex flex-stack flex-wrap flex-md-nowrap card-rounded shadow text-center" style="background: linear-gradient(90deg, #20AA3E 0%, #03A588 100%);z-index: 1;max-width: 1100px;position: relative; margin-bottom: -15rem;">
          ...
          <div class="my-2 mx-10">
            ...
            <span class="fw-normal">Prof. Dr. Ir. H. Husain Syam, M.TP., IPU, ASEAN.Eng.</span></div>
            <!--end::Title-->
            <!--begin::Description-->
            <div class="fs-6 fs-lg-5 text-white fw-bold opacity-75" style="text-align: justify;">"Tracer study merupakan survei alumni dengan tujuan menggali informasi yang berkaitan dengan perjalanan lulusan, mulai dari saat mereka menyelesaikan masa pendidikannya di perguruan tinggi (PT) sampai pada waktu pelaksanaan survei. Data dan informasi yang alumni berikan sangat bermanfaat untuk keperluan evaluasi hasil pendidikan tinggi, penyempurnaan dan penjaminan kualitas lembaga pendidikan tinggi dan relevansi pendidikan tinggi, informasi bagi para pemangku kepentingan (stakeholders), kelengkapan persyaratan bagi akreditasi pendidikan tinggi serta yang paling penting adalah sebagai pemenuhan indikator kinerja utama perguruan tinggi."</div>
            <!--end::Description-->
          </div>
          <!--end::Content-->
          <!--begin::Link-->
          ...
          <div class="text-center w-100">
            ...
            <img src="assets/media/husain-unm-depan1.png" class="" alt="" style="max-width: 300px;border-radius: 0.625rem;">
          </div>
          <!--end::Link-->
        </div>
        <!--end::Highlight-->
                ...
                <div class="row w-100 gy-10 mb-md-20">
                    ...
                    <div class="col-md-3 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            ...
                            <!--end::Heading-->
                            <!--begin::Description-->
                            <div class="fw-bold fs-6 fs-lg-4 text-muted">Akses Halaman Website <a
                                    href="https://tracerstudy.unm.ac.id"> https://tracerstudy.unm.ac.id</a></div>
                            <!--end::Description-->
                        </div>
                        <!--end::Story-->
                    </div>
                    ...
                    <div class="col-md-3 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            ...
                            <!--end::Heading-->
                            <!--begin::Description-->
                            <div class="fw-bold fs-6 fs-lg-4 text-muted">Login Menggunakan Username dan Password Nim Pada
                                Saat Berkuliah di UNM</div>
                            <!--end::Description-->
                        </div>
                        <!--end::Story-->
                    </div>
                    ...
                    <div class="col-md-3 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            ...
                            <!--end::Heading-->
                            <!--begin::Description-->
                            <div class="fw-bold fs-6 fs-lg-4 text-muted">Melakukan Update Terhadap Data Profile Sesuai
                                dengan Status Alumni Pada Saat Ini</div>
                            <!--end::Description-->
                        </div>
                        <!--end::Story-->
                    </div>
                    ...
                    <div class="col-md-3 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            ...
                            <!--end::Heading-->
                            <!--begin::Description-->
                            <div class="fw-bold fs-6 fs-lg-4 text-muted">Melakukan Pengisian Kuesioner Sesuai Dengan Status
                                dan Kondisi Alumni Pada Saat Ini</div>
                            <!--end::Description-->
                        </div>
                        <!--end::Story-->
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="d-flex flex-column container pt-lg-15">
                        ...
                        <div class="mb-5 text-center">
                            <h1 class="fs-2hx fw-bolder text-white mb-5" id="tentang"
                                data-kt-scroll-offset="{default: 100, lg: 150}">Aplikasi Tracer Studi UNM</h1>
                ...
                <div class="d-flex h-100 align-items-center">
                  ...
                  <!--end::Option-->
                                ...
                                <div class="col-xl-12">
                                    <div class="d-flex h-100 align-items-center">
                                        <!--begin::Option-->
                                        <div class="w-100 d-flex flex-column flex-center rounded-3 py-20 px-10"
                                            style="background: linear-gradient(0deg, #306e59 0%, #6ec6a8 100%);">
                                            <!--begin::Heading-->
                                            <div class="mb-7 text-center">
                                                <!--begin::Title-->
                                                ...
                                                <!--end::Title-->
                                                <!--begin::Description-->
                                                <div class="text-white fw-bold mb-5"
                                                    style="text-align: justify;
                                                                                                                                                                                                                                                                                  font-size: 18px;">

                                                    Tracer Study (Studi Penelusuran Alumni) Universitas Negeri Makassar
                                                    merupakan survei yang dilakukan untuk mengukur proses pendidikan tinggi
                                                    UNM dalam membekali para alumni untuk memasuki masa transisi dari dunia
                                                    kampus ke dunia kerja. Selain itu, Tracer Study UNM juga bertujuan untuk
                                                    mendapatkan masukan bagi perbaikan sistem pendidikan dan pembelajaran
                                                    UNM.
                                                    <br>
                                                    <br>
                                                    Merupakan suatu hal yang membanggakan jika Anda bersedia meluangkan
                                                    waktu sejenak untuk membantu Kami dalam pelaksanaan suatu survei yang
                                                    ditujukan kepada seluruh alumni Universitas Negeri Makasar.
                                                    <br>
                                                    <br>
                                                    Partisipasi para alumni dalam mengisi kuesioner Tracer Study sangat
                                                    berharga dalam memberikan kontribusi pengembangan dan peningkatan mutu
                                                    pendidikan dan pembelajaran di Universitas Negeri Makassar di masa yang
                                                    akan datang. Kami yakin Anda akan bersedia untuk saling berbagi dengan
                                                    almamater Anda guna berlangsungnya proses peningkatan' mutu pendidikan
        ...
        <div class="mt-20 mb-n20 position-relative z-index-2">
            ...
            <div class="container">
                ...
                <div class="text-center mb-17">
                    <!--begin::Title-->
                    <h3 class="fs-2hx text-dark mb-5" id="kontak" data-kt-scroll-offset="{default: 125, lg: 150}">
                        Kontak
                        Tracer Study UNM</h3>
                    <!--end::Title-->
                    <!--begin::Description-->
                ...
                <div class="row g-lg-10 mb-10 mb-lg-20">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div
                            ...
                            <div class="row g-10">
                                <!--begin::Col-->
                                <div class="card p-5 col-md-6 pe-lg-10"
                                    style="box-shadow: 0 0 84px 0 rgb(136 87 125 / 18%);">
                                    <!--begin::Form-->
                                    <form action="" class="form mb-15" method="post" id="kt_contact_form">
                                        ...
                                        <div class="d-flex flex-column mb-10 fv-row">
                                            <label class="fs-6 fw-bold mb-2">Pertanyaan</label>
                                    ...
                                    <div id="kt_contact_map" class="w-100 rounded mb-2 mb-lg-0 mt-2"
                                        ...
                                        <div class="rounded landing-dark-border p-9 mb-10">
                                            ...
                                            <span class="fw-normal fs-4 "> <strong> Gedung Phinisi Lantai 6</strong> <br>
                                                ...
                                                Makassar 90222 <br>
                                                Indonesia <br>
                                                Whatsapp: +62 822-3140-2975 <br>
                                            </span>
                                            <!--end::Text-->
                                        </div>
                                        <iframe
                                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3973.597122737833!2d119.43243431536229!3d-5.168324553636237!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dbee29192be2437%3A0xf9f6d01676cfaae1!2sMenara%20Pinisi%20UNM!5e0!3m2!1sid!2sid!4v1646895194745!5m2!1sid!2sid"
                ...
                <div class="d-flex flex-stack flex-wrap flex-md-nowrap card-rounded shadow p-8 p-lg-12 mb-n5 mb-lg-n13"
                    ...
                    <div class="my-2 me-5">
                        ...
                        <!--end::Title-->
                        <!--begin::Description-->
                        <div class="fs-6 fs-lg-5 text-white fw-bold opacity-75">Join over 100,000 Professionals Community
                            to Stay Ahead</div>
                        <!--end::Description-->
                    </div>
                    <!--end::Content-->
