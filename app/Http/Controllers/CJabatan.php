...
class CJabatan extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return Datatables::of(jabatan::all())->addIndexColumn()->addColumn('aksi', function ($data) {
