...
class CReport extends Controller
{
    ...
    {
        return  view('admin/report/va_report_status',);
    }

    public function masatunggu()
    {
        return  view('admin/report/va_report_masatunggu');
    }
    ...
    public function jtb()
    {
        return  view('admin/report/va_report_jtb');
    }

    public function ttb()
    {
        return  view('admin/report/va_report_ttb');
    }

    public function sdk()
    {
        return  view('admin/report/va_report_sdk');
    }

    public function vertikal()
    {
        return  view('admin/report/va_report_vertikal');
    }

    public function horizontal()
    {
        return  view('admin/report/va_report_horizontal');
    }

    public function ikusatu()
    {
        return  view('admin/report/va_report_ikusatu');
    }

    public function kompetensi()
    {
        return  view('admin/report/va_report_kompetensi');
    }

    public function penghasilan()
    {
        return  view('admin/report/va_report_penghasilan');
    }

    public function jumlah_responden()
    {
        return  view('admin/report/va_report_jumlah_responden');
    }
    ...
    public function hasilstatus(Request $request)
    {
        ...
        if ($jreport == 'status') {
            $nilaijreport = 'Status';
            if ($tahun == '') {
                return  view('admin/report/va_report_status')->with('successMsg', 'Harap Memasukkan Tahun .');
            } else {
                ...
                if ($nilaiumum == null) {
                    return  view('admin/report/va_report_status')->with('successMsg', 'Data pada Tahun ' . $tahun . ' Tidak Ditemukan');
                } else {
                    ...
                    $no = 1;
                    return view('admin/report/va_report_status_hasil', compact('chart', 'chartdua', 'dataprodi', 'bekerja', 'wiraswasta', 'lanjut', 'tdkkerja', 'blmkerja', 'no', 'nialin', 'jreport', 'nilaijreport'));
                }
            }
            ...
            if ($tahun == '') {
                return  view('admin/report/va_report_masatunggu')->with('successMsg', 'Harap Memasukkan Tahun .');
            } else {
                if ($kelompok == 'univ') {
                    $dataumum = DB::table('questioners')
                        ->join('questionersatus', 'questionersatus.id_questioners', '=', 'questioners.id')
                    ...
                    if ($nilaiumum == null) {
                        return  view('admin/report/va_report_masatunggu')->with('successMsg', 'Data pada Tahun ' . $tahun . ' Tidak Ditemukan');
                    } else {
                        ...
                        $no = 1;
                        return view('admin/report/va_report_status_hasil', compact('chart', 'chartdua', 'datauniv', 'nilaibawah', 'nilaiatas', 'no', 'nialin', 'jreport', 'nilaijreport', 'bawah', 'atas', 'kelompok', 'scoresMedian'));
                    }
                    ...
                    if ($nilaiumum == null) {
                        ...
                        $no = 1;
                        $noa = 0;
                        return view('admin/report/va_report_status_hasil', compact('chart', 'chartdua', 'datafakultas',  'no', 'nialin', 'jreport', 'nilaijreport', 'kelompok', 'bawah', 'atas', 'medianfak', 'noa'));
                    }
                    ...
                    if ($nilaiumum == null) {
                        ...
                        $no = 1;
                        return view('admin/report/va_report_status_hasil', compact('chart', 'chartdua', 'dataprodi',  'no', 'nialin', 'jreport', 'nilaijreport', 'kelompok', 'bawah', 'atas',));
                    }
                }
            }
            ...
            if ($tahun == '') {
                return  view('admin/report/va_report_penghasilan')->with('successMsg', 'Harap Memasukkan Tahun .');
            } else {
                $dataumum = DB::table('questioners')
                    ->join('questionersatus', 'questionersatus.id_questioners', '=', 'questioners.id')
                    ->get()
                ...
                if ($nilaiumum == null) {
                    return  view('admin/report/va_report_penghasilan')->with('successMsg', 'Data pada Tahun ' . $tahun . ' Tidak Ditemukan');
                } else {
                    ...
                    $no = 1;
                    return view('admin/report/va_report_status_hasil', compact(
                        'dataprodi',
                        'datac1',
                        'datac2',
                        'datac3',
            ...
            if ($tahun == '') {
                return  view('admin/report/va_report_jtb')->with('successMsg', 'Harap Memasukkan Tahun .');
            } else {
                ...
                if ($nilaiumum == null) {
                    return  view('admin/report/va_report_jtb')->with('successMsg', 'Data pada Tahun ' . $tahun . ' Tidak Ditemukan');
                } else {
                    if ($kelompok == 'univ') {
            ...
            if ($tahun == '') {
                return  view('admin/report/va_report_ttb')->with('successMsg', 'Harap Memasukkan Tahun .');
            } else {
                $dataumum = DB::table('questioners')
                    ->join('questionersatus', 'questionersatus.id_questioners', '=', 'questioners.id')
                    ->get()
                ...
                if ($nilaiumum == null) {
                    ...
                    $no = 1;
                    return view('admin/report/va_report_status_hasil', compact('chart', 'chartdua', 'dataprodi', 'datac1', 'datac2', 'datac3', 'no', 'nialin', 'jreport', 'nilaijreport'));
                }
            }
        } elseif ($jreport == 'sdk') {
            ...
            if ($tahun == '') {
                ...
                if ($nilaiumum == null) {
                    return  view('admin/report/va_report_sdk')->with('successMsg', 'Data pada Tahun ' . $tahun . ' Tidak Ditemukan');
                } else {
            ...
            if ($tahun == '') {
                return  view('admin/report/va_report_vertikal')->with('successMsg', 'Harap Memasukkan Tahun .');
            } else {
                $dataumum = DB::table('questioners')
                    ->join('questionersatus', 'questionersatus.id_questioners', '=', 'questioners.id')
                    ->get()
                ...
                if ($nilaiumum == null) {
                    return  view('admin/report/va_report_vertikal')->with('successMsg', 'Data pada Tahun ' . $tahun . ' Tidak Ditemukan');
                } else {
            ...
            if ($tahun == '') {
                return  view('admin/report/va_report_horizontal')->with('successMsg', 'Harap Memasukkan Tahun .');
            } else {
                $dataumum = DB::table('questioners')
                    ->join('questionersatus', 'questionersatus.id_questioners', '=', 'questioners.id')
                    ->get()
                ...
                if ($nilaiumum == null) {
                    return  view('admin/report/va_report_horizontal')->with('successMsg', 'Data pada Tahun ' . $tahun . ' Tidak Ditemukan');
                } else {
            ...
            $kelompok = $request->kelompok;
            // return  view('admin/report/va_report_ikusatu')->with('successMsg', 'Sedang Maintenance');

            $nilaijreport = 'Kesesuaian IKU 1';
            if ($tahun == '') {
                return  view('admin/report/va_report_ikusatu')->with('successMsg', 'Harap Memasukkan Tahun .');
            } else {
                if ($kelompok == 'univ') {
                    $dataumum = DB::table('questioners')
                        ->join('questionersatus', 'questionersatus.id_questioners', '=', 'questioners.id')
                    ...
                    if ($nilaiumum == null) {
                        return  view('admin/report/va_report_ikusatu')->with('successMsg', 'Data pada Tahun ' . $tahun . ' Tidak Ditemukan');
                    } else {
                        ...
                        $no = 1;
                        return view('admin/report/va_report_status_hasil', compact('chart', 'datauniv', 'nilaidatac1', 'nilaidatac2', 'nilaidatac3', 'no', 'nialin', 'jreport', 'nilaijreport', 'kelompok', 'chartdua', 'presentasetotal'));
                    }
                } else if ($kelompok == 'fakultas') {
                    $datafakultas = DB::table('fakultas')
                        ->orderBy('urutan')
            ...
            if ($tahun == '') {
                return  view('admin/report/va_report_kompetensi')->with('successMsg', 'Harap Memasukkan Tahun .');
            } else {
                $dataumum = DB::table('questioners')
                    ->join('questionersatus', 'questionersatus.id_questioners', '=', 'questioners.id')
                ...
                if ($nilaiumum == null) {
                    return  view('admin/report/va_report_kompetensi')->with('successMsg', 'Data pada Tahun ' . $tahun . ' Tidak Ditemukan');
                } else {
            ...
            if ($tahun == '') {
                return  view('admin/report/va_report_jumlah_responden')->with('successMsg', 'Harap Memasukkan Tahun .');
            } else {
                $dataumum = DB::table('questioners')
                    ->join('questionersatus', 'questionersatus.id_questioners', '=', 'questioners.id')
                    ->join('questionersduas', 'questionersduas.id_questioners', '=', 'questioners.id')
                ...
                if ($nilaiumum == null) {
                    return  view('admin/report/va_report_jumlah_responden')->with('successMsg', 'Data pada Tahun ' . $tahun . ' Tidak Ditemukan');
                } else {
                    ...
                    $no = 1;
                    return view('admin/report/va_report_status_hasil', compact('chart', 'chartdua', 'no', 'nialin', 'jreport', 'dataprodi', 'nilaijreport', 'dataumum', 'datalulusanmaster'));
                }
            }
        } else {
            echo "koko";
